 ...
 * Last generated by Orchestration Designer at: 31 DE MAYO DE 2019 12:47:23 COT
 */
public class BuenasNoches extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("BuenasNoches", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("MenuPrincipal");
		return submit;
	}
	/**
