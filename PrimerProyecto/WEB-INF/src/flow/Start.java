 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 13 DE JUNIO DE 2019 14:57:24 COT
 */
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 14 DE JUNIO DE 2019 9:29:15 COT
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("Saludo");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.UNTITLED_FIELD_CONTADOR,
			IProjectVariables.UNTITLED_FIELD_CONTADOR_2 };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.UNTITLED, variableFields, new String[] {"0", "0"}, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TRANSFERENCIA_2, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TRANSFERENCIA_3, "", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.MENU_PRINCIPAL_FIELD_CONFIDENCE,
			IProjectVariables.MENU_PRINCIPAL_FIELD_INPUTMODE,
			IProjectVariables.MENU_PRINCIPAL_FIELD_INTERPRETATION,
			IProjectVariables.MENU_PRINCIPAL_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_PRINCIPAL_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_PRINCIPAL_FIELD_UTTERANCE,
			IProjectVariables.MENU_PRINCIPAL_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_PRINCIPAL, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.MENU_OPCION_DOS_FIELD_CONFIDENCE,
			IProjectVariables.MENU_OPCION_DOS_FIELD_INPUTMODE,
			IProjectVariables.MENU_OPCION_DOS_FIELD_INTERPRETATION,
			IProjectVariables.MENU_OPCION_DOS_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_OPCION_DOS_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_OPCION_DOS_FIELD_UTTERANCE,
			IProjectVariables.MENU_OPCION_DOS_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_OPCION_DOS, variableFields, null, session, false, false );
		session.putVariable(variable);
