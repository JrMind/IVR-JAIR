 ...
 * Last generated by Orchestration Designer at: 14 DE JUNIO DE 2019 8:50:46 COT
 */
public class OpcionValidaCopy extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("OpcionValida", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("MenuOpcionDos");
		return submit;
	}
	/**
